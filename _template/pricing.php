    ...
    <div class="row row-cols-1 row-cols-md-3 mb-3 text-center">
        ...
        <div class="card mb-4 rounded-3 shadow-sm">
          ...
          <div class="card-body">
            ...
            <ul class="list-unstyled mt-3 mb-4">
              <li>Single photo and no video</li>
              <li>View stats and Leads online</li>
              <li>Email support</li>
      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm">
          ...
          <div class="card-body">
            ...
            <ul class="list-unstyled mt-3 mb-4">
              <li>upto 6 photos and videos</li>
              <li>contact list Buyers</li>
      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm border-primary">
          ...
          <div class="card-body">
            <h1 class="card-title pricing-card-title">₹5000<small class="text-body-secondary fw-light">/mo</small></h1>
            <ul class="list-unstyled mt-3 mb-4">
              <li>unlimited photos and videos</li>
              <li>Appears top at search</li>
